<form action="<?php echo getUrl("Entrada", "Entrada", "postHerramientas"); ?>" method="post">
  <!-- Titulo de la modadal -->
  <h5 id="title">Herramientas</h5>
    ...
    <div class="cointainer-fluid" id="contenedor">
      <div class="row">
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12">
          <label>Tipo:</label><br>
          <input type="text" value="Herramientas" class="form-control" readonly>
        </div>
