...
<input type="hidden" name="Soc_id" value="<?php echo $soli['Soc_id'] ?>">
            <input id="birthday" class="date-picker form-control" name="Soc_fecha"
                value="<?php echo $soli['Soc_fecha']; ?>" placeholder="dd-mm-aaa" type="text" 
        ...
        <div class="col-md-3 col-sm-6 ">
            <select name="Reg_id" class="form-control" id="selectRegio" data-url="<?php echo 
    ...
    <div class="item form-group">
        ...
        <div class="col-md-3 col-sm-7 ">
            <input class="date-picker form-control" type="text" id="Soc_area" name="Soc_area" value="<?php echo $soli['Soc_area']; ?>"
        ...
        <div class="col-md-3 col-sm-6 ">
            ...
            <select name="Cen_id" id="selectCentro" class="form-control">
                <?php
    ...
    <div class="item form-group">
        ...
        <div class="col-md-3 col-sm-7 ">
            <input class="date-picker form-control" type="text" id="Soc_nom_je" name="Soc_nom_je"
        ...
        <div class="col-md-3 col-sm-7 ">
        <input class="date-picker form-control" type="text" id="Soc_servidorp" name="Soc_servidorp"
    ...
    <div class="item form-group">
        ...
        <div class="col-md-3 col-sm-7 ">
        <input class="date-picker form-control" type="number" id="Soc_DNI_jefeOficina" name="Soc_DNI_jefeOficina"
        ...
        <div class="col-md-3 col-sm-7 ">
            <input class="date-picker form-control" type="number" id="Soc_DNI_servidorPublico" name="Soc_DNI_servidorPublico" type="number"
                value="<?php echo $soli['Soc_DNI_servidorPublico']; ?>" size="10" maxlength="20">
        </div>
    </div>
    <div class="item form-group">
        <label class="col-form-label col-mb-3 col-sm-2 label-align">
        ...
        <div class="col-md-3 col-sm-4 ">
            <input class="date-picker form-control" type="text" name="Soc_ficha"
        ...
        <div class="form-row ml-6 w-75 m-auto" name="com_NoItem" id="com_NoItem">
            <div class="form-group col-md-12 ml-5" id="contenedor">
                <div class="col-md-12 row ml-5 ">
                    <div class="form-control col-2" style="background-color:#17A481; color:#fff;">Descripcion de
                        bien</div>
                ...
                <div class="form col-md-12 row ml-5" id="clon">
                    ...
                    <input type="text" value="<?php echo $comp['com_Cantidad']; ?>" id="com_Cantidad"
                        name="com_Cantidad[]" class="form-control col-2 " placeholder="">
                    <input type="text" value="<?php echo $comp['com_Observaciones']; ?>" id="com_Observaciones"
                        name="com_Observaciones[]" class="form-control col-2 validar producto" rows="1" cols="50"
