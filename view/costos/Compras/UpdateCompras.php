<div class="x_title ">
    <h2>Editar Solicitud Cotizacion de Productos N° <?php echo $Soc_id; ?> </h2>
...
<form action="<?php echo getUrl("costos", "compras", "postUpdate") ?>" method="post">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-3 col-sm-6 ">
            ...
            <select name="Cen_id" id="selectCentro" class="form-control" required>
                <?php
    ...
    <div class="item form-group">
        ...
        <div class="col-md-3 col-sm-7 ">
            <input class="date-picker form-control" type="text" name="Soc_nom_je" value="<?php echo $soli['Soc_nom_je']; ?>">
        </div>
        <label class="col-form-label col-md-4 col-sm-2 label-align">
            <h6>No.Documento:</h6> <span class="required"></span>
        </label>
        <div class="col-md-2 col-sm-7 ">
            <input class="date-picker form-control" type="number" name="Soc_DNI_jefeOficina" value="<?php echo $soli['Soc_DNI_jefeOficina']; ?>" size="15" maxlength="30">
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-7 ">
            <input class="date-picker form-control" type="text" name="Soc_servidorp" value="<?php echo $soli['Soc_servidorp']; ?>" size="15" maxlength="30">
        </div>
        <label class="col-form-label col-md-3 col-sm-2 label-align">
            <h6>No.Documento:</h6> <span class="required"></span>
        </label>
        <div class="col-md-2 col-sm-5 ">
            <input class="date-picker form-control" type="number" name="Soc_DNI_servidorPublico" type="number" value="<?php echo $soli['Soc_DNI_servidorPublico']; ?>" size="10" maxlength="20">
        </div>
    </div>
    <div class="item form-group">
        <label class="col-form-label col-mb-3 col-sm-2 label-align">
        ...
        <div class="col-md-3 col-sm-4 ">
            <input class="date-picker form-control" type="number" name="Soc_ficha" value="<?php echo $soli['Soc_ficha']; ?>" size="15" maxlength="30">
        </div>
    </div>
        ...
        <div class="form-group col-md-12 ml-5" id="contenedor">
            ...
            ?>
                ...
                <div class="form col-md-12 row ml-5" id="clon">
                    <select name="Pba_id[]" id="Pba_id" class="form-control col-3">
                        <option value="">Seleccione...</option>
                        <?php
                    ...
                    <input type="text" value="<?php echo $comp['com_Observaciones']; ?>" id="com_Observaciones" name="com_Observaciones[]" class="form-control col-2 validar producto" rows="1" cols="50" placeholder="Observacion...">
                    <?php
                    if ($contador > 1) {
                    ?>
...
<div class="col-md-6 col-sm-6 offset-md-5">
    <a href="<?php echo getUrl("costos", "compras", "consult"); ?>"><button type='button' class="btn btn-primary">Cancelar</button></a>
