...
<form action="<?php echo getUrl("costos","compras","postInsert");?>" enctype="multipart/form-data" method="post">
    ...
    <div class="item form-group">
            <label class="col-form-label col-md-2 col-sm-2 label-align"><h6> fecha:</h6> <span class="required"></span>
            </label>
            <div class="col-md-3 col-sm-6 ">
                <input id="birthday" class="date-picker form-control" name="Soc_fecha" placeholder="dd-mm-aaa" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                <script>
    ...
    <div class="item form-group">
            ...
            <div class="col-md-3 col-sm-7 ">
             <input class="date-picker form-control" name="Soc_area" required="required" type="text" size="15" maxlength="30">
            </div>
            ...
            <select name="Reg_id" id="Reg_id" class="form-control" >
                    <option value="">Seleccione...</option><span class="required"></span>
                    <?php
    ...
    <div class="item form-group">
            ...
            <div class="col-md-3 col-sm-7 ">
             <input class="date-picker form-control" name="Soc_nom_je" required="required" type="text" size="15" maxlength="30">
            </div>
            ...
            <div class="col-md-2 col-sm-7 ">
             <input class="date-picker form-control" name="Soc_DNI_jefeOficina" required="required" type="number" size="15" maxlength="30">
            </div>
    </div>
    <div class="item form-group">
            ...
            <div class="col-md-4 col-sm-7 ">
             <input class="date-picker form-control" name="Soc_servidorp"  required="required" type="text" size="15" maxlength="30">
            </div>
            <label class="col-form-label col-md-3 col-sm-2 label-align"><h6>No.Documento:</h6> <span class="required"></span>
            </label>
            <div class="col-md-2 col-sm-5 ">
             <input class="date-picker form-control" name="Soc_DNI_servidorPublico" required="required" type="number" size="10" maxlength="20">
            </div>
    </div>
    <div class="item form-group">
    <label class="col-form-label col-mb-3 col-sm-2 label-align"><h6>Ficha de caracterización:</h6> <span class="required"></span>
            ...
            <div class="col-md-3 col-sm-4 ">
             <input class="date-picker form-control" name="Soc_ficha" required="required" type="number" size="15" maxlength="30">
            </div>
    </div>
    <br>
    ...
    <div class="form-row ml-6 ">
        <div class="form-group col-md-10 ml-5" id="contenedor">
            ...
            <div class=" form col-12 row ml-5" id="clon">  
                 <input type="number"  id="com_CodigoSena" name="com_CodigoSena[]" class="form-control col-2 validar producto">
                <textarea class="form-control col-3" id="com_Descripcionb" name="com_Descripcionb[]" rows="1" cols="50"
                    placeholder="Descripcion del bien.."></textarea>
                    <input id="com_UMedida" type="number" name="com_UMedida[]" class="form-control col-2 " placeholder="">
                    <input type="number" id="com_Cantidad" name="com_Cantidad[]" class="form-control col-2 " placeholder="">
                    <textarea id="com_Observaciones" name="com_Observaciones[]" class="form-control col-2"  rows="1" cols="50"
