    ...
    <form id="AlertInsertOrden" action="<?php echo getUrl("Mantenimiento", "orden", "postInsert"); ?>" method="POST" onsubmit="return validarCamposVaciosMantoOI();" enctype="multipart/form-data">
        <div class="contenedor_de_datos x_panel">
            ...
            <div class="row justify-content-end" id="fechas">
                <div class="col-md-3 caja">
                    ...
                    <input class="form-control" type="date" id="fechaI" name="Odm_fechaInicio">
                </div>
                <div class="col-md-3 caja">
                    <label for="date">Fecha de Fin</label>
                    <input class="form-control" type="date" id="fechaF" name="Odm_fechaFin">
                </div>
            </div>
            <div class="row justify-content-start" id="nombres">
                <div class="col-md-6 caja">
                    <label>Nombre del encargado *</label>
                    <select id="encargado" name="Usu_id" class="form-control">
                    ...
                    <p id="encargado" class="form_input-error"><span class="fa fa-times-circle"></span> * La descripcion solo puede contener letras.</p>
                </div>
                <div class=" selector col-md-4 caja">
                    <label>Tipo de mantenimiento</label>
                    <select id="tipomantenimiento" name="Stg_id" class="form-control">
            ...
            <div class="row justify-content-start">
                <div class="col-md-6 caja">
                    ...
                    <select id="maquina" name="Maq_id" class="form-control">
                ...
                <div class="col-md-4 caja">
                    ...
                    <input id="tecnico" class="form-control" type="text" name="Odm_tecnico" placeholder="..." aria-describedby="equipamento">
                    <small id="equipamento" class="form-text text-muted">* Recuerde verificar la debida equipacion del
                        tecnico</small>
                    <p id="tecnicoP" class="form_input-error"><span class="fa fa-times-circle"></span> * El nombre solo puede contener letras.</p>
                </div>
                <div class="empresa_desactivada col-md-6 caja" style="display:none;">
                    <label for="nombreTecnico">Nombre de la Empresa *</label>
                    <select id="empresa" name="Emp_id" class="empresa_elegida form-control">
        ...
        <div class="x_panel">
            ...
            <div class="col-md-12">
                ...
                <textarea id="observacionI" class="form-control" name="Odm_observaciones" rows="3" placeholder="Maquina en estado..." style=" margin-top: 0px; margin-bottom: 50px; height: 90px; resize: none;"></textarea>
                <div>
        ...
        <div class="x_panel">
            ...
            <div class="row justify-content-end" id="horas">
                <div class="col-md-3 caja">
                    ...
                    <input id="horaI" type="time" name="Odm_horainicio" class="form-control">
                </div>
                <div class="col-md-3 caja">
                    <label>Hora de fin</label>
                    <input id="horaF" type="time" name="Odm_horaFin" class="form-control">
                </div>
            </div>
            <!--------tareas------------------->
            <div class="x_panel">
        ...
        <div class="x_panel">
            ...
            <div class="col-md-12">
                ...
                <textarea id="observacionF" class="form-control" name="Odm_observacionesFin" rows="3" placeholder="Se le elaboró..." style=" margin-top: 0px; margin-bottom: 50px; height: 90px; resize: none;"></textarea>
                <div>
