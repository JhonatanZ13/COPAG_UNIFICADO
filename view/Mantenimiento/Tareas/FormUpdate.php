...
<div class="x_content">
    <form id="FormConfirmacionUpdate" action="<?php echo getUrl("Mantenimiento", "Tareas", "UpdateForm"); ?>" method="POST">
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="row justify-content-start" id="fechas">
                <div class="col-md-6 caja">
                    ...
                    <input type="text" name="Tar_nombre" value="<?php echo $Tar['Tar_nombre']; ?>" class="form-control">
                ...
                <div class="col-md-6 caja">
                    ...
                    <p><input type="text" name="Tar_descripcion" value="<?php echo $Tar['Tar_descripcion']; ?>"
