$(document).ready(function() {
    ...
    $(document).on("click", "#showMore", function() {
        ...
        if (status == 0) {
            ...
            $('.containerLogin').children().first().next().next().html('<p>Por favor digite el codigo que le fue enviado al correo electronico que inscribiste en el sistema de informacion COPAG</p>');
