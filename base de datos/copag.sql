...
(1, 'prueba', 1, '12', 4, '', 'prueba', 1, 1);

--
-- Disparadores `tblarticulo`
--
DELIMITER $$
CREATE TRIGGER `TrTID_AU` AFTER UPDATE ON `tblarticulo` FOR EACH ROW BEGIN
    CALL
        ActualizoBitacora(
            OLD.Arti_nombre,
            OLD.Arti_cantidad,
...
(12, 'root@localhost', '2021-07-02 05:35:17', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Reprograf paso de: 5 a: 6 unidades'),
(13, 'root@localhost', '2021-07-02 05:35:48', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Reprograf paso de: 6 a: 7 unidades'),
(14, 'root@localhost', '2021-07-02 05:35:48', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Martillo paso de: 5 a: 7 unidades'),
(15, 'root@localhost', '2021-07-02 05:36:57', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Reprograf paso de: 7 a: 6 unidades'),
(16, 'root@localhost', '2021-07-02 05:36:57', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Martillo paso de: 7 a: 6 unidades'),
(17, 'root@localhost', '2021-07-02 06:03:52', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Reprograf paso de: 6 a: 5 unidades'),
(18, 'root@localhost', '2021-07-02 06:03:52', 'tipo_id', 'Actualizo ', 'Se actualizó la cantidad de Martillo paso de: 6 a: 5 unidades');
...
(1, 'Centro de Diseño Tecnologico Industrial', '4315800 Ext: 22667', 'Cl. 72k #26J - 97, Barrio El Pondaje', 1),
(2, 'Centro Agroindustrial del Meta', 'N/A', 'Cra. 9 No. 20-52 Barrio Montoya Pava Granada', 33),
(3, 'Centro de Industria y Servicios del Meta', '6825505', 'Carrera 48 No.06-40 Urbanización Guayuriba Vi', 33);
...
(7, 'entonces toca colocar col-md-6 y col-ms-6?', '../web/images/Firma/tomy.jpg', 1);
...
--
DELIMITER $$
CREATE TRIGGER `TrHID_AU` AFTER UPDATE ON `tblherramienta` FOR EACH ROW BEGIN
    CALL
        ActualizoBitacora(
            OLD.Her_nombre,
            OLD.Her_cantidad,
...
(1, 'Oliver', 0x313235623362352d6b, 'The Oliver Typewriter Company (en español: La', '../web/images/Maquina/maquinaPredeterminada.jpg', 1, 13, 18, '../web/images/Maquina/Ficha/20170227-Manual Artes Graficas.pdf', '../web/images/Maquina/Manual/OrdenProduccion_3.pdf'),
(2, 'Sakurai', 0x3132332d6838, 'Año 1994\r\nModelo SC-102AⅡ\r\ncondiciones de tra', '../web/images/Maquina/maquinaPredeterminada.jpg', 1, 14, 16, '../web/images/Maquina/Ficha/20170227-Manual Artes Graficas.pdf', '../web/images/Maquina/Manual/20170227-Manual Artes Graficas.pdf'),
...
(4, 'Certificados', 1),
(5, 'Plegables', 1),
(6, 'Formatos Coorporativos ', 1),
(7, 'Stickers', 1),
(8, 'Habladores', 1),
(9, 'Libreta con lomo', 1),
(10, 'Libreta con anillo', 1),
(11, 'Revista ', 1),
(12, 'Carpetas ', 1),
(13, 'Libros', 1),
(14, 'Separador de libros', 1),
(15, 'Pendones', 1),
(16, 'Estampados', 1),
(17, 'Vasos Plasticos', 1);
...
(4, 'Regional Nariño'),
(5, 'Regional Cauca'),
(6, 'Regional Antioquia'),
(7, 'Regional Bogota'),
(8, 'Regional Boyaca'),
(9, 'Regional Caldas'),
(10, 'Regional Cundinamarca'),
(11, 'Regional Norte de Santander'),
(12, 'Regional Huila'),
(13, 'Regional Quindio'),
(14, 'Regional Risaralda'),
(15, 'Regional Santader'),
(16, 'Regional Tolima'),
(17, 'Regional Atlantico'),
(18, 'Regional Bolivar'),
(19, 'Regional Cesar'),
(20, 'Regional Cordoba'),
(21, 'Regional Guajira'),
(22, 'Regional Magdalena'),
(23, 'Regional San Andres'),
(24, 'Regional Sucre'),
(25, 'Regional Amazonas'),
(26, 'Regional Caqueta'),
(27, 'Regional Guainia'),
(28, 'Regional Putumayo'),
(29, 'Regional Vaupes'),
(30, 'Regional Arauca'),
(31, 'Regional Casanare'),
(32, 'Regional Guaviare'),
(33, 'Regional Meta');
...
(1, '2021-06-01', 567654, 87756, 'ggv', 2346, 'ghgh', 2, 'vggcg', 1);
...
(14, 'Automatica', 1),
(15, 'Maquina Compleja', 2),
(16, 'Maquina Mecanica', 2),
(17, 'Maquina Simple', 2),
(18, 'Maquina Termica', 2),
...
--
ALTER TABLE `tblcotizacion`
  MODIFY `Cot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tblmaquina`
  MODIFY `Maq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tblproductobase`
  MODIFY `Pba_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
ALTER TABLE `tblcomprasinsumos`
  ...
  ADD CONSTRAINT `tblcomprasinsumos_ibfk_5` FOREIGN KEY (`Arti_id`) REFERENCES `tblarticulo` (`Arti_id`);
